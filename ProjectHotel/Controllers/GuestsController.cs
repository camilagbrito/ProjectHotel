...
namespace ProjectHotel.Controllers
{
    public class GuestsController : Controller
    {
        ...
        public GuestsController(ProjectHotelDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Guest != null ? 
                          ...
                          Problem("Entity set 'ProjectHotelDbContext.Guest'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Guest guest, Address address)
        {
            if (id != guest.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjectHotelDbContext.Guest'  is null.");
            }
            var guest = await _context.Guest.FindAsync(id);
            if (guest != null)
            {
